...
analyze -format sverilog -vcs "-f ../scripts/sources.f"	;# The source.f is automatically generated by the previous step

set design des_unit_core0
...
set_dft_signal -type PLLClock 	 -port clk_noc_i 		 -view existing -timing [list 45 55] -test_mode all_dft -usage occ 
set_dft_signal -type ScanClock	 -port pipe_clk	 	 	 -view existing -timing [list 45 55] -test_mode all_dft  

set_dft_signal -type PLLClock    -hookup_pin u_pll_gen/pll_clk_1 -view spec     -timing [list 45 55] -test_mode all_dft -usage occ 
set_dft_signal -type PLLClock    -hookup_pin u_pll_gen/pll_clk_2 -view spec     -timing [list 45 55] -test_mode all_dft -usage occ 
set_dft_signal -type PLLClock    -hookup_pin u_pll_gen/pll_clk_4 -view spec     -timing [list 45 55] -test_mode all_dft -usage occ 

set_dft_signal -type wrp_clock   -port vl_sms_WRCK



set_dft_signal -type reset      -port rst_st_1 	    -view existing   -active_state 1 
set_dft_signal -type reset      -port rst_st_2 	    -view existing   -active_state 1 
...
set_dft_asynchronous_controller         -async [list rst_st_1 rst_st_2 vl_sms_WRSTN ] \
	                                -cell_name rst_ctrl \
				        -ateclock ate_clk \
...
set_dft_clock_controller                -cell_name core_occ_ctrl_local \
                                        -pllclocks [list u_pll_gen/pll_clk_1 \
                                                         u_pll_gen/pll_clk_2 \
                                                         u_pll_gen/pll_clk_4] \
                                        -ateclock ate_clk \
                                        -cycles_per_clock $occ_chain_len \
...
set_logicbist_configuration -chain_count $core_chain_count \
                             ...
                             -occ_clock_weights [list [list 10 vl_sms_WRCK ]\
                                                      [list 10 clk_noc_i]\
                                                      [list 10 u_pll_gen/pll_clk_1 ]\
                                                      [list 10 u_pll_gen/pll_clk_2 ]\
                                                      [list 10 u_pll_gen/pll_clk_4] ] \
                             -reset_weights     [list [list 1 rst_st_1]\
                                                      [list 1 rst_st_2]\
                                                      [list 1 vl_sms_WRSTN] ] 
 ...
 write_test_protocol -test_mode xlbist -out ../outputs/des_unit.xlbist.spf
 write_test_protocol -test_mode sccomp -out ../outputs/des_unit.sccomp.spf
 write_test_protocol -test_mode wrp_if -out ../outputs/des_unit.wrp_if.spf
 write_test_protocol -test_mode scan -out ../outputs/des_unit.scan.spf
 write_test_protocol -test_mode wrp_of -out ../outputs/des_unit.wrp_of.spf
 write_test_protocol -test_mode my_wrp_of -out ../outputs/des_unit.my_wrp_of.spf
 write_test_model -out ../outputs/des_unit.ctl
 write_test_model -test_mode wrp_of -out ../outputs/des_unit.wrp_of.ctl
 set_svf formality -replace
 write_dft_constraints -out ../outputs/des_unit_dft_constraints
 
 exec mkdir  ../outputs/sdc
 write_test_timing -output ../outputs/sdc/des_unit_sdc_constraints_none_shift   -test_mode none  -mode shift   -occ active
 write_test_timing -output ../outputs/sdc/des_unit_sdc_constraints_none_capture -test_mode none  -mode capture -occ active
 write_test_timing -output ../outputs/sdc/des_unit_sdc_constraints_none_any     -test_mode none  -mode any	    -occ active
 
 current_test_mode xlbist
  write_test_timing -output ../outputs/sdc/des_unit_sdc_constraints_xlbist_shift   -test_mode defined  -mode shift   -occ active
  write_test_timing -output ../outputs/sdc/des_unit_sdc_constraints_xlbist_capture -test_mode defined  -mode capture -occ active
  write_test_timing -output ../outputs/sdc/des_unit_sdc_constraints_xlbist_any     -test_mode defined  -mode any     -occ active

 current_test_mode sccomp 
  write_test_timing -output ../outputs/sdc/des_unit_sdc_constraints_sccomp_shift   -test_mode defined  -mode shift   -occ active
  write_test_timing -output ../outputs/sdc/des_unit_sdc_constraints_sccomp_capture -test_mode defined  -mode capture -occ active
  write_test_timing -output ../outputs/sdc/des_unit_sdc_constraints_sccomp_any     -test_mode defined  -mode any     -occ active
